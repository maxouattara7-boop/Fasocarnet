...
import { Customer, DebtPayment, DebtRecord, Product, Sale, ShopProfile, LicenseKey, Expense, StockSupply, CustomInvoice } from '../types';
...
export class FasoCarnetDB extends Dexie {
  ...
  customInvoices!: Table<CustomInvoice, string>;
